...
var letters3 = ["Tenderloin", "Mission", "Russian Hill", "North Beach", "Marina", "Castro/Upper Market", "Golden Gate Park", "Lone Mountain/USF", "Haight Ashbury"];

var updateData2 = function() {
  // get the textarea "value" (i.e. the entered text)
  let text = d3.select("body").select("textarea").node().value;
  let map2 = d3.map();
  map2.set("Tenderloin", 287);
  map2.set("Mission", 285);
  map2.set("Russian Hill", 203);
  map2.set("North Beach", 173);
  map2.set("Marina", 155);
  map2.set("Castro/Upper Market", 115);
  map2.set("Golden Gate Park", 64);
  map2.set("Lone Mountain/USF", 51);
  map2.set("Haight Ashbury", 43);
...
var drawBarChart = function() {
  ...
  bars.enter().append("rect")
    ...
    .attr("height", function(d) {
  	...
  	.attr("fill", function(d){return colorScheme2(d.key);})
    ...
    svg.append("text")
      ...
      .text("Larceny Theft in Lone Mountain/USF vs. San Francisco Neighborhoods in December 2018");
